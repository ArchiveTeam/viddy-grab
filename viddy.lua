...
wget.callbacks.download_child_p = function(urlpos, parent, depth, start_url_parsed, iri, verdict, reason)
  ...
  if (item_type == "viddyvideo2" or item_type == "viddyvideo3") and (downloaded[newurl] ~= true or addedtolist[newurl] ~= true) then
    if (string.match(url, item_url1) and string.match(url, item_url2)) or (string.match(url, item_url1) and string.match(url, item_url2) and string.match(url, item_url3))
...
--  if item_type == "viddyvideo2" or item_type == "viddyvideo3" then
    if (string.match(url, item_url1) and string.match(url, item_url2)) or (string.match(url, item_url1) and string.match(url, item_url2) and string.match(url, item_url3)) then
      ...
      for customurl in string.gmatch(html, '"(http[s]?://[^"]+)"') do
        ...
        io.stdout:flush()
        if string.match(customurl, "viddy%.it") or string.match(customurl, "viddy%.com/[^/]+/v/") or string.match(customurl, "viddy%.com/[^/]+/m/") or string.match(customurl, "use%.typekit%.com") or string.match(customurl, "p%.typekit%.com") or string.match(customurl, "viddy%-assets%.com") or string.match(customurl, "cdn%.viddy%.com") or string.match(customurl, "livepassdl%.conviva%.com") or string.match(customurl, "api%.mixpanel%.com") or string.match(customurl, "gwa%.lphbs%.com") or string.match(customurl, "gwc%.lphbs%.com") or string.match(customurl, "gwd%.lphbs%.com") or string.match(customurl, "cdn%.mxpnl%.com") or string.match(customurl, "/resources/") or string.match(customurl, "/images/") or string.match(customurl, "/v1/") or string.match(customurl, "/static/") or string.match(customurl, "/media/") or string.match(customurl, "/ajax/") then
